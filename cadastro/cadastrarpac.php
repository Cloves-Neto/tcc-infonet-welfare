...
<head>
    ...
    <title>Welfare | Paciente ADM</title>
...
<div class="granbox">
    ...
    <section class="infosite">
        <!-- titulo da sessao -->
        <header>
            <h2 class="titulo-pagina" style="text-align: center;">cadastrar paciente</h2>
        </header>
            ...
            <div class="popup-content">
                ...
                <div class="wrapper">
                    ...
                    <label class="lbl_container" for="cpf_paciente">
                        CPF
                        <input type="number" id="cpf_paciente" name="cpf_paciente">
                    </label>
                    <label class="lbl_container" for="rg_paciente">
                        RG
                        <input type="number" id="rg_paciente" name="rg_paciente">
                    </label>
                    ...
                    <label class="lbl_container" for="cpf_responsavel">
                        CPF
                        <input type="number" id="cpf_responsavel" name="cpf_responsavel">
                    </label>
                    <label class="lbl_container" for="rg_responsavel">
                        RG
                        <input type="number" id="rg_responsavel" name="rg_responsavel">
                    </label>
                    <label class="lbl_container">
                        Sexo 
                        <div>
                    ...
                    <label class="lbl_container" for="uf">
                        UF
                        <input type="text" maxlength="2" id="uf" name="uf">
                    </label>
                    ...
                    <label class="lbl_container" for="cep_paciente">
                        CEP
                        <input type="number" id="cep_paciente" name="cep_paciente">
                    </label>
                    <label class="lbl_container" for="numero_casa_paciente">
                        N°
                        <input type="number" id="numero_casa_paciente" name="numero_casa_paciente">
                    </label>
                </div>
