...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlUpdate = "UPDATE paciente SET nome_paciente = :nome_paciente, email_paciente = :email_paciente, contato_paciente = :contato_paciente, dt_nascimento_paciente = :dt_nascimento_paciente WHERE cpf_paciente = :cpf_paciente";
    $stmt = $conexao->prepare($sqlUpdate);
    $stmt->bindParam(':nome_paciente', $nome_paciente);
    $stmt->bindParam(':email_paciente', $email);
